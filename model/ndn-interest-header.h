...
public:
  ...
  /**
   * \brief Get content locator
   *
   * Gets locator of content in the interest.
   **/
  const NameComponents&
  GetLocator () const;
...
private:
  ...
  Ptr<NameComponents> m_locator;    ///< Interest content location. not used if m_locator==0
